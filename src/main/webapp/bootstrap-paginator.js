...
console.log("currentTarget------>",currentTarget,type);
        ...
        getPages: function () {
            ...
            var totalPages = this.totalPages,// get or calculate the total
                ...
                pageStart = (this.currentPage % this.numberOfPages === 0) ? (parseInt(this.currentPage / this.numberOfPages, 10) - 1) * this.numberOfPages + 1 : parseInt(this.currentPage / this.numberOfPages, 10) * this.numberOfPages + 1,// calculates
																																																												// the
																																																												// start
																																																												// page.
                output = [],
